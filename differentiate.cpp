...
void Differentiate::differentiatePlusMinus(deque<Node> &tree, int index) {
    ...
    string l = subtreeToString(tree, index + 2);
...
void Differentiate::differentiateSinCos(deque<Node> &tree, int index) {
    ...
    string r = subtreeToString(tree, index + 2);
...
string Differentiate::subtreeToString(deque<Node> tree, int index) {
    stringstream s;
